...
* ⭐️ [typage](https://github.com/FiloSottile/typage) — TypeScript implementation on top of libsodium.js, available as [an npm package](https://www.npmjs.com/package/age-encryption).
